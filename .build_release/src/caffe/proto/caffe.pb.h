...
class BinLossParameter;
class SigmoidFineCEParameter;
...
enum FocalLossParameter_Engine {
  FocalLossParameter_Engine_DEFAULT = 0,
  FocalLossParameter_Engine_CAFFE = 1,
  FocalLossParameter_Engine_CUDNN = 2
};
bool FocalLossParameter_Engine_IsValid(int value);
const FocalLossParameter_Engine FocalLossParameter_Engine_Engine_MIN = FocalLossParameter_Engine_DEFAULT;
const FocalLossParameter_Engine FocalLossParameter_Engine_Engine_MAX = FocalLossParameter_Engine_CUDNN;
const int FocalLossParameter_Engine_Engine_ARRAYSIZE = FocalLossParameter_Engine_Engine_MAX + 1;

const ::google::protobuf::EnumDescriptor* FocalLossParameter_Engine_descriptor();
inline const ::std::string& FocalLossParameter_Engine_Name(FocalLossParameter_Engine value) {
  return ::google::protobuf::internal::NameOfEnum(
    FocalLossParameter_Engine_descriptor(), value);
}
inline bool FocalLossParameter_Engine_Parse(
    const ::std::string& name, FocalLossParameter_Engine* value) {
  return ::google::protobuf::internal::ParseNamedEnum<FocalLossParameter_Engine>(
    FocalLossParameter_Engine_descriptor(), name, value);
}
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.SigmoidFineCEParameter sigmoid_fine_ce_loss_param = 147;
  inline bool has_sigmoid_fine_ce_loss_param() const;
  inline void clear_sigmoid_fine_ce_loss_param();
  static const int kSigmoidFineCeLossParamFieldNumber = 147;
  inline const ::caffe::SigmoidFineCEParameter& sigmoid_fine_ce_loss_param() const;
  inline ::caffe::SigmoidFineCEParameter* mutable_sigmoid_fine_ce_loss_param();
  inline ::caffe::SigmoidFineCEParameter* release_sigmoid_fine_ce_loss_param();
  inline void set_allocated_sigmoid_fine_ce_loss_param(::caffe::SigmoidFineCEParameter* sigmoid_fine_ce_loss_param);

  // optional .caffe.FocalLossParameter focal_loss_param = 148;
  inline bool has_focal_loss_param() const;
  inline void clear_focal_loss_param();
  static const int kFocalLossParamFieldNumber = 148;
  ...
  // optional .caffe.BinLossParameter bin_loss_param = 149;
  inline bool has_bin_loss_param() const;
  inline void clear_bin_loss_param();
  static const int kBinLossParamFieldNumber = 149;
  inline const ::caffe::BinLossParameter& bin_loss_param() const;
  inline ::caffe::BinLossParameter* mutable_bin_loss_param();
  inline ::caffe::BinLossParameter* release_bin_loss_param();
  inline void set_allocated_bin_loss_param(::caffe::BinLossParameter* bin_loss_param);
 ...
 private:
  ...
  inline void set_has_sigmoid_fine_ce_loss_param();
  inline void clear_has_sigmoid_fine_ce_loss_param();
  inline void set_has_focal_loss_param();
  inline void clear_has_focal_loss_param();
  inline void set_has_bin_loss_param();
  inline void clear_has_bin_loss_param();
  ...
  ::caffe::SigmoidFineCEParameter* sigmoid_fine_ce_loss_param_;
  ::caffe::FocalLossParameter* focal_loss_param_;
  ::caffe::BinLossParameter* bin_loss_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class BinLossParameter : public ::google::protobuf::Message {
 public:
  BinLossParameter();
  virtual ~BinLossParameter();

  BinLossParameter(const BinLossParameter& from);

  inline BinLossParameter& operator=(const BinLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const BinLossParameter& default_instance();

  void Swap(BinLossParameter* other);

  // implements Message ----------------------------------------------

  BinLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const BinLossParameter& from);
  void MergeFrom(const BinLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional int32 key = 1 [default = 20];
  ...
  // optional int32 lambda = 2 [default = 1];
  inline bool has_lambda() const;
  inline void clear_lambda();
  static const int kLambdaFieldNumber = 2;
  inline ::google::protobuf::int32 lambda() const;
  inline void set_lambda(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:caffe.BinLossParameter)
 private:
  ...
  ::google::protobuf::int32 lambda_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static BinLossParameter* default_instance_;
};
// -------------------------------------------------------------------

class SigmoidFineCEParameter : public ::google::protobuf::Message {
 public:
  SigmoidFineCEParameter();
  virtual ~SigmoidFineCEParameter();

  SigmoidFineCEParameter(const SigmoidFineCEParameter& from);

  inline SigmoidFineCEParameter& operator=(const SigmoidFineCEParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SigmoidFineCEParameter& default_instance();

  void Swap(SigmoidFineCEParameter* other);

  // implements Message ----------------------------------------------

  SigmoidFineCEParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SigmoidFineCEParameter& from);
  void MergeFrom(const SigmoidFineCEParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 threshold_range = 1 [default = 5];
  inline bool has_threshold_range() const;
  inline void clear_threshold_range();
  static const int kThresholdRangeFieldNumber = 1;
  inline ::google::protobuf::uint32 threshold_range() const;
  inline void set_threshold_range(::google::protobuf::uint32 value);

  // optional float threshold_alpha = 2 [default = 1];
  inline bool has_threshold_alpha() const;
  inline void clear_threshold_alpha();
  static const int kThresholdAlphaFieldNumber = 2;
  inline float threshold_alpha() const;
  inline void set_threshold_alpha(float value);

  // optional float threshold_beta = 3 [default = 2];
  inline bool has_threshold_beta() const;
  inline void clear_threshold_beta();
  static const int kThresholdBetaFieldNumber = 3;
  inline float threshold_beta() const;
  inline void set_threshold_beta(float value);

  // optional float topk_scale = 4 [default = 0.9];
  inline bool has_topk_scale() const;
  inline void clear_topk_scale();
  static const int kTopkScaleFieldNumber = 4;
  inline float topk_scale() const;
  inline void set_topk_scale(float value);

  // @@protoc_insertion_point(class_scope:caffe.SigmoidFineCEParameter)
 private:
  inline void set_has_threshold_range();
  inline void clear_has_threshold_range();
  inline void set_has_threshold_alpha();
  inline void clear_has_threshold_alpha();
  inline void set_has_threshold_beta();
  inline void clear_has_threshold_beta();
  inline void set_has_topk_scale();
  inline void clear_has_topk_scale();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::uint32 threshold_range_;
  float threshold_alpha_;
  float threshold_beta_;
  float topk_scale_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
  ...
  void InitAsDefaultInstance();
  static SigmoidFineCEParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class FocalLossParameter : public ::google::protobuf::Message {
 public:
  ...
  typedef FocalLossParameter_Engine Engine;
  static const Engine DEFAULT = FocalLossParameter_Engine_DEFAULT;
  static const Engine CAFFE = FocalLossParameter_Engine_CAFFE;
  static const Engine CUDNN = FocalLossParameter_Engine_CUDNN;
  static inline bool Engine_IsValid(int value) {
    return FocalLossParameter_Engine_IsValid(value);
  }
  static const Engine Engine_MIN =
    FocalLossParameter_Engine_Engine_MIN;
  static const Engine Engine_MAX =
    FocalLossParameter_Engine_Engine_MAX;
  static const int Engine_ARRAYSIZE =
    FocalLossParameter_Engine_Engine_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Engine_descriptor() {
    return FocalLossParameter_Engine_descriptor();
  }
  static inline const ::std::string& Engine_Name(Engine value) {
    return FocalLossParameter_Engine_Name(value);
  }
  static inline bool Engine_Parse(const ::std::string& name,
      Engine* value) {
    return FocalLossParameter_Engine_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional .caffe.FocalLossParameter.Engine engine = 1 [default = DEFAULT];
  inline bool has_engine() const;
  inline void clear_engine();
  static const int kEngineFieldNumber = 1;
  inline ::caffe::FocalLossParameter_Engine engine() const;
  inline void set_engine(::caffe::FocalLossParameter_Engine value);
  ...
  // optional float gamma = 4 [default = 2];
  inline bool has_gamma() const;
  inline void clear_gamma();
...
// optional .caffe.SigmoidFineCEParameter sigmoid_fine_ce_loss_param = 147;
inline bool LayerParameter::has_sigmoid_fine_ce_loss_param() const {
  return (_has_bits_[1] & 0x00040000u) != 0;
}
inline void LayerParameter::set_has_sigmoid_fine_ce_loss_param() {
  _has_bits_[1] |= 0x00040000u;
}
inline void LayerParameter::clear_has_sigmoid_fine_ce_loss_param() {
  _has_bits_[1] &= ~0x00040000u;
}
inline void LayerParameter::clear_sigmoid_fine_ce_loss_param() {
  if (sigmoid_fine_ce_loss_param_ != NULL) sigmoid_fine_ce_loss_param_->::caffe::SigmoidFineCEParameter::Clear();
  clear_has_sigmoid_fine_ce_loss_param();
}
inline const ::caffe::SigmoidFineCEParameter& LayerParameter::sigmoid_fine_ce_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.sigmoid_fine_ce_loss_param)
  return sigmoid_fine_ce_loss_param_ != NULL ? *sigmoid_fine_ce_loss_param_ : *default_instance_->sigmoid_fine_ce_loss_param_;
}
inline ::caffe::SigmoidFineCEParameter* LayerParameter::mutable_sigmoid_fine_ce_loss_param() {
  set_has_sigmoid_fine_ce_loss_param();
  if (sigmoid_fine_ce_loss_param_ == NULL) sigmoid_fine_ce_loss_param_ = new ::caffe::SigmoidFineCEParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.sigmoid_fine_ce_loss_param)
  return sigmoid_fine_ce_loss_param_;
}
inline ::caffe::SigmoidFineCEParameter* LayerParameter::release_sigmoid_fine_ce_loss_param() {
  clear_has_sigmoid_fine_ce_loss_param();
  ::caffe::SigmoidFineCEParameter* temp = sigmoid_fine_ce_loss_param_;
  sigmoid_fine_ce_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_sigmoid_fine_ce_loss_param(::caffe::SigmoidFineCEParameter* sigmoid_fine_ce_loss_param) {
  delete sigmoid_fine_ce_loss_param_;
  sigmoid_fine_ce_loss_param_ = sigmoid_fine_ce_loss_param;
  if (sigmoid_fine_ce_loss_param) {
    set_has_sigmoid_fine_ce_loss_param();
  } else {
    clear_has_sigmoid_fine_ce_loss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.sigmoid_fine_ce_loss_param)
}
...
// optional .caffe.BinLossParameter bin_loss_param = 149;
inline bool LayerParameter::has_bin_loss_param() const {
  return (_has_bits_[1] & 0x00100000u) != 0;
}
inline void LayerParameter::set_has_bin_loss_param() {
  _has_bits_[1] |= 0x00100000u;
}
inline void LayerParameter::clear_has_bin_loss_param() {
  _has_bits_[1] &= ~0x00100000u;
}
inline void LayerParameter::clear_bin_loss_param() {
  if (bin_loss_param_ != NULL) bin_loss_param_->::caffe::BinLossParameter::Clear();
  clear_has_bin_loss_param();
}
inline const ::caffe::BinLossParameter& LayerParameter::bin_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.bin_loss_param)
  return bin_loss_param_ != NULL ? *bin_loss_param_ : *default_instance_->bin_loss_param_;
}
inline ::caffe::BinLossParameter* LayerParameter::mutable_bin_loss_param() {
  set_has_bin_loss_param();
  if (bin_loss_param_ == NULL) bin_loss_param_ = new ::caffe::BinLossParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.bin_loss_param)
  return bin_loss_param_;
}
inline ::caffe::BinLossParameter* LayerParameter::release_bin_loss_param() {
  clear_has_bin_loss_param();
  ::caffe::BinLossParameter* temp = bin_loss_param_;
  bin_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_bin_loss_param(::caffe::BinLossParameter* bin_loss_param) {
  delete bin_loss_param_;
  bin_loss_param_ = bin_loss_param;
  if (bin_loss_param) {
    set_has_bin_loss_param();
  } else {
    clear_has_bin_loss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.bin_loss_param)
}
...
// optional int32 key = 1 [default = 20];
inline bool BinLossParameter::has_key() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void BinLossParameter::set_has_key() {
  _has_bits_[0] |= 0x00000001u;
}
inline void BinLossParameter::clear_has_key() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void BinLossParameter::clear_key() {
  key_ = 20;
  clear_has_key();
}
inline ::google::protobuf::int32 BinLossParameter::key() const {
  // @@protoc_insertion_point(field_get:caffe.BinLossParameter.key)
  return key_;
}
inline void BinLossParameter::set_key(::google::protobuf::int32 value) {
  set_has_key();
  key_ = value;
  // @@protoc_insertion_point(field_set:caffe.BinLossParameter.key)
}

// optional int32 lambda = 2 [default = 1];
inline bool BinLossParameter::has_lambda() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void BinLossParameter::set_has_lambda() {
  _has_bits_[0] |= 0x00000002u;
}
inline void BinLossParameter::clear_has_lambda() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void BinLossParameter::clear_lambda() {
  lambda_ = 1;
  clear_has_lambda();
}
inline ::google::protobuf::int32 BinLossParameter::lambda() const {
  // @@protoc_insertion_point(field_get:caffe.BinLossParameter.lambda)
  return lambda_;
}
inline void BinLossParameter::set_lambda(::google::protobuf::int32 value) {
  set_has_lambda();
  lambda_ = value;
  // @@protoc_insertion_point(field_set:caffe.BinLossParameter.lambda)
}
...
// optional uint32 threshold_range = 1 [default = 5];
inline bool SigmoidFineCEParameter::has_threshold_range() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void SigmoidFineCEParameter::set_has_threshold_range() {
  _has_bits_[0] |= 0x00000001u;
}
inline void SigmoidFineCEParameter::clear_has_threshold_range() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void SigmoidFineCEParameter::clear_threshold_range() {
  threshold_range_ = 5u;
  clear_has_threshold_range();
}
inline ::google::protobuf::uint32 SigmoidFineCEParameter::threshold_range() const {
  // @@protoc_insertion_point(field_get:caffe.SigmoidFineCEParameter.threshold_range)
  return threshold_range_;
}
inline void SigmoidFineCEParameter::set_threshold_range(::google::protobuf::uint32 value) {
  set_has_threshold_range();
  threshold_range_ = value;
  // @@protoc_insertion_point(field_set:caffe.SigmoidFineCEParameter.threshold_range)
}

// optional float threshold_alpha = 2 [default = 1];
inline bool SigmoidFineCEParameter::has_threshold_alpha() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void SigmoidFineCEParameter::set_has_threshold_alpha() {
  _has_bits_[0] |= 0x00000002u;
}
inline void SigmoidFineCEParameter::clear_has_threshold_alpha() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void SigmoidFineCEParameter::clear_threshold_alpha() {
  threshold_alpha_ = 1;
  clear_has_threshold_alpha();
}
inline float SigmoidFineCEParameter::threshold_alpha() const {
  // @@protoc_insertion_point(field_get:caffe.SigmoidFineCEParameter.threshold_alpha)
  return threshold_alpha_;
}
inline void SigmoidFineCEParameter::set_threshold_alpha(float value) {
  set_has_threshold_alpha();
  threshold_alpha_ = value;
  // @@protoc_insertion_point(field_set:caffe.SigmoidFineCEParameter.threshold_alpha)
}

// optional float threshold_beta = 3 [default = 2];
inline bool SigmoidFineCEParameter::has_threshold_beta() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void SigmoidFineCEParameter::set_has_threshold_beta() {
  _has_bits_[0] |= 0x00000004u;
}
inline void SigmoidFineCEParameter::clear_has_threshold_beta() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void SigmoidFineCEParameter::clear_threshold_beta() {
  threshold_beta_ = 2;
  clear_has_threshold_beta();
}
inline float SigmoidFineCEParameter::threshold_beta() const {
  // @@protoc_insertion_point(field_get:caffe.SigmoidFineCEParameter.threshold_beta)
  return threshold_beta_;
}
inline void SigmoidFineCEParameter::set_threshold_beta(float value) {
  set_has_threshold_beta();
  threshold_beta_ = value;
  // @@protoc_insertion_point(field_set:caffe.SigmoidFineCEParameter.threshold_beta)
}

// optional float topk_scale = 4 [default = 0.9];
inline bool SigmoidFineCEParameter::has_topk_scale() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void SigmoidFineCEParameter::set_has_topk_scale() {
  _has_bits_[0] |= 0x00000008u;
}
inline void SigmoidFineCEParameter::clear_has_topk_scale() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void SigmoidFineCEParameter::clear_topk_scale() {
  topk_scale_ = 0.9f;
  clear_has_topk_scale();
}
inline float SigmoidFineCEParameter::topk_scale() const {
  // @@protoc_insertion_point(field_get:caffe.SigmoidFineCEParameter.topk_scale)
  return topk_scale_;
}
inline void SigmoidFineCEParameter::set_topk_scale(float value) {
  set_has_topk_scale();
  topk_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.SigmoidFineCEParameter.topk_scale)
}
...
// optional .caffe.FocalLossParameter.Engine engine = 1 [default = DEFAULT];
inline bool FocalLossParameter::has_engine() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void FocalLossParameter::set_has_engine() {
  _has_bits_[0] |= 0x00000001u;
}
inline void FocalLossParameter::clear_has_engine() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void FocalLossParameter::clear_engine() {
  engine_ = 0;
  clear_has_engine();
}
inline ::caffe::FocalLossParameter_Engine FocalLossParameter::engine() const {
  // @@protoc_insertion_point(field_get:caffe.FocalLossParameter.engine)
  return static_cast< ::caffe::FocalLossParameter_Engine >(engine_);
}
inline void FocalLossParameter::set_engine(::caffe::FocalLossParameter_Engine value) {
  assert(::caffe::FocalLossParameter_Engine_IsValid(value));
  set_has_engine();
  engine_ = value;
  // @@protoc_insertion_point(field_set:caffe.FocalLossParameter.engine)
}

// optional int32 axis = 2 [default = 1];
inline bool FocalLossParameter::has_axis() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void FocalLossParameter::set_has_axis() {
  _has_bits_[0] |= 0x00000002u;
}
inline void FocalLossParameter::clear_has_axis() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void FocalLossParameter::clear_axis() {
  axis_ = 1;
  clear_has_axis();
}
inline ::google::protobuf::int32 FocalLossParameter::axis() const {
  // @@protoc_insertion_point(field_get:caffe.FocalLossParameter.axis)
  return axis_;
}
inline void FocalLossParameter::set_axis(::google::protobuf::int32 value) {
  set_has_axis();
  axis_ = value;
  // @@protoc_insertion_point(field_set:caffe.FocalLossParameter.axis)
}
...
template <> struct is_proto_enum< ::caffe::FocalLossParameter_Engine> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::FocalLossParameter_Engine>() {
  return ::caffe::FocalLossParameter_Engine_descriptor();
}
